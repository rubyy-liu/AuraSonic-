    ...
    <div className="relative">
      ...
      <section className="relative h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div className="absolute inset-0 bg-gradient-to-t from-aura-900 via-aura-900/60 to-transparent z-10" />
          <img 
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl lg:text-9xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-aura-highlight to-aura-accent mb-6 tracking-tight drop-shadow-2xl">
              AURASONIC
            </h1>
          </motion.div>
          ...
          >
            <Link to="/services" className="px-8 py-3 bg-aura-accent hover:bg-violet-600 text-white font-semibold rounded-full transition-all flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(139,92,246,0.5)]">
              Our Services <ArrowRight className="w-4 h-4" />
            </Link>
            <Link to="/shows" className="px-8 py-3 bg-white/10 hover:bg-white/20 text-white border border-white/20 font-semibold rounded-full transition-all flex items-center justify-center">
              Upcoming Shows
            </Link>
          </motion.div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 md:order-1">
              <div className="aspect-square rounded-2xl overflow-hidden relative shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-500">
